    ...
    return(
        <div className="w-full h-auto bg-[#F7E8FF] py-[88px]" >
            <div className="text-center max-w-[800px] mx-auto">
                ...
                <p className="text-[20px]/[30px] textgray mt-[35px] sfprorg" >Inspiring stories from creatives in the industry, Insights from the world of art and design: 
                    Peekaboo Podcast breaks through to fire your imagination. Tune in and join the creative conversation now. </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-[30px] gap-x-[20px]">
                    <div className="w-[490px] max-h-[162px] rounded-[24px] p-[24px] bg-[#F9F9F9] flex border border-[#b6b6b6] ">
                        ...
                        <div className="relative flex flex-col justify-between w-[334px] ml-[10px]">
                            <h2 className="text-[20px]/[26px] text-[#151515] max-w-[302px] morangarg">Perspective of an Burma
                                Illustrator: Meet Ko Harley Aung</h2>
                    ...
                    <div className="w-[490px] max-h-[162px] rounded-[24px] p-[24px] bg-[#F9F9F9] flex border border-[#b6b6b6]">
                        ...
                        />
                        <div className="relative flex flex-col justify-between w-[334px] ml-[10px]">
                            <h2 className="text-[20px]/[26px] text-[#151515] max-w-[302px]">Perspective of an Burma
                                Illustrator: Meet Ko Harley Aung</h2>
            ...
            <div className="mx-auto flex items-center mt-[24px]">
                <button className="py-[14px] px-[24px]rounded rounded-[24px] border-none w-[183px] h-[47px] cursor-pointer text-[#fff] bg-[#AA16FF] text-[16px]/auto mx-auto sfprorg">View On YouTube</button>
            </div>
            </div>
        </div>
    )

  ...
  return (
    <div className='w-full h-auto bg-[#F7E8FF] py-[88px]'>
      <div className='text-center max-w-[800px] mx-auto'>
        <h1 className=' text-[32px]/[40px] lg:text-[48px]/[64px] text-[#AA16FF] morangarg'>Podcast program for art and design</h1>
        <p className='text-[18px]/[24px] lg:text-[20px]/[30px] textgray mt-[35px] sfprorg'>
      ...
      <div className='max-w-[1102px] mx-auto flex flex-col gap-[15px] justify-around mt-[68px] morangarg'>
        <p className='text-[16px]'>Listen full episode on YouTube</p>
        <div className='grid grid-cols-2 gap-[20px] lg:gap-[30px] gap-x-[20px]'>
          <div className='w-[353px] lg:w-[520px] max-h-[162px] rounded-[24px] p-[14px] lg:p-[24px] bg-[#F9F9F9] flex border border-[#b6b6b6] '>
            <Image
              src='/assets/Images/peekaboo Image 1.jpg'
              alt='sample'
              width={109}
              height={109}
              className='mr-[10px] mt-[2px] rounded-[16px] size-[48px] lg:size-[109px]'
            />
            <div className='relative flex flex-col w-[334px] ml-[10px]'>
              <h2 className='text-[16px] lg:text-[20px]/[26px] text-[#151515] max-w-[302px] morangarg line-clamp-1'>
                Perspective of an Burma Illustrator: Meet Ko Harley Aung
              </h2>
              <p className='text-[14px] mt-[5px] lg:text-[16px] sfpromd'>Host By Ko Nu</p>
              <p className='text-[14px] mt-[5px] lg:text-[16px] text-[#aa16ff] sfpromd'>02:10 Mins</p>
              <Image
                src={playbutton}
          ...
          <div className='w-[333px] lg:w-[520px] max-h-[162px] rounded-[24px] p-[24px] bg-[#F9F9F9] flex border border-[#b6b6b6]'>
            <Image
              src='/assets/Images/peekaboo Image 1.jpg'
              alt='sample'
              width={109}
            ...
            <div className='relative flex flex-col justify-between w-[334px] ml-[10px]'>
              ...
              <p className='text-[16px] mt-[5px]'>Host By Ko Nu</p>
              <p className='text-[16px] mt-[5px] text-[#aa16ff]'>02:10 Mins</p>
              <Image
                src={playbutton}
                alt='Peekaboo illustration'
                width={48}

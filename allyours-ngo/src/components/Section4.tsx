    ...
    <div className='w-full h-auto bg-[#F7E8FF] py-[54px] md:py-[88px]' id="section4">
      ...
      <div className='max-w-[1102px] mx-auto flex flex-col items-center text-start gap-[15px] justify-around mt-[68px] morangarg'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-[20px] xl:gap-[30px] '>
          <div className='w-[353px] xl:w-[520px] max-h-[100px] xl:max-h-[162px] rounded-[24px] p-[14px] xl:p-[24px] bg-[#F9F9F9] flex border border-[#b6b6b6] '>
            <Image
              src='/assets/Images/peekaboo Image 1.jpg'
              alt='sample'
              width={109}
              height={109}
              className='mr-[10px] mt-[2px] rounded-[16px] size-[48px] xl:size-[109px]'
            />
            <div className='relative flex flex-col w-[334px] ml-[10px]'>
              <h2 className='text-[16px] xl:text-[20px]/[26px] text-[#151515] max-w-[302px] morangarg line-clamp-1'>
                Perspective of an Burma Illustrator: Meet Ko Harley Aung
              </h2>
              <p className='text-[14px] mt-[5px] xl:text-[16px] sfpromd'>Host By Ko Nu</p>
              <p className='text-[14px] mt-[5px] xl:text-[16px] text-[#aa16ff] sfpromd'>02:10 Mins</p>
              <Image
                src={playbutton}
                alt='Peekaboo illustration'
                width={48}
                height={48}
                className='absolute right-0 xl:right-[-20px] bottom-0'
              />
            </div>

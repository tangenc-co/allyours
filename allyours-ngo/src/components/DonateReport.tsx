export default function DonateReport() {
  return (
    <div id='donators-report' className='mt-[100px] px-4 w-full max-w-[1440px] mx-auto text-center scroll-mt-24'>
      ...
      <p className='sfprorg text-[16px] md:text-[18px] lg:text-[20px] leading-[28px] md:leading-[30px] text-[#151515] font-light max-w-[460px] mx-auto mt-4'>
        Your donations helped us strengthen our organization and expand our community impact.
      </p>
    </div>
  )
}

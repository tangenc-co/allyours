    ...
    return (
      <div className="min-h-screen max-w-[1213px] mx-auto">
        ...
        <div className="text-center mt-[50px] max-w-[1104px] mx-auto mb-[100px]">
            <p className="text-[68px]/[80px] mb-[-10px] bg-[#fff] morangamd mb-[30px]">Cultivating Creative Minds Retaining Design Intelligence</p>
            <p className="text-[20px]/[30px] textgray sfprorg mb-[30px]">We’re on a mission to cherish and elevate design talent by tackling brain drain and creative burnout through skill growth, community support and meaningful purposes. Let’s shape a stronger future for the industry, beginning from today. </p>

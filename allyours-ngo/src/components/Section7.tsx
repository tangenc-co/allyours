  ...
  const questions = [
    {
      ...
      answer:
        'To create an inclusive environment that is not limited to project leaders from ethnic minorities, with disabilities, and internally displaced people because of civil war, we are committed to accepting diversity and practicing inclusive habits in our communications with stakeholders, applicants, and customers, as well as within our internal teams.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'As one of our vision aims for building a net-zero future, we will be dedicated to carrying out our missions with human, social, economic and environmental sustainability practices with a deep focus on creating eco-friendly spaces and procedures, regular assessments and advancing through feedback. ',
    },
  ]

  return (
    // min-h-[100vh] xl:min-h-[120vh]
    <div className='h-auto text-center pt-[70px] md:pt-[120px] pb-[60px] xl:pb-[80px]'>
                  ...
                  <div className='max-w-[625px]'>
                    ...
                    <div className='absolute top-[0] right-[0]'>
                      {activeIndex === idx ? (
                        ...
                        <Image src={plus} alt='expand' width={24} height={24} />
                      )}
                    </div>
                  </div>
                </button>
                {activeIndex === idx && (
                  <p className='mt-[10px] sfprorg textgray text-[20px]/[26px] max-w-[580px]'>{item.answer}</p>
                )}
              </div>
            ))}
          </div>

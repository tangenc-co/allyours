        ...
        <>
            <div className="bg-[##005CFF] text-center min-h-[352px] py-[72px] bg-[#005CFF] flex flex-col items-center justify-around">
                ...
                <div className="flex gap-[64px]">
                    <div className="text-center text-[#f9f9f9] max-w-[376px] min-h-[180px] flex flex-col items-center justify-evenly ">
                            ...
                            <p className="sfpromd text-[16px]">Fostering collaboration and creativity by connecting project leaders with real industry exposure</p>
                    </div>
                    <div className="text-center text-[#f9f9f9] max-w-[376px] min-h-[180px] flex flex-col items-center justify-evenly ">
                            <Image 
                                src={emoji} 
            ...
            <div className="min-h-[300px] bg-[#005CFF] text-start py-[92px] flex flex-col items-center">
                <div className="max-w-[1256px] flex flex-col gap-[32px] text-[#f9f9f9] text-start">
                        ...
                        <p className="sfprorg text-[20px]/[30px]">Download and explore our journey of past achievements and the meaningful impact we've made in communities. From empowering youth and fostering inclusive growth to creating real opportunities for change, our milestones reflect a shared commitment to building a brighter, sustainable futures for creative industry. </p>
